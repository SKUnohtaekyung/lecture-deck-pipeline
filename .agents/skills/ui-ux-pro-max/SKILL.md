...
> **Note:** On Windows, run the repository-local skill with `python .agents/skills/ui-ux-pro-max/scripts/search.py ...`.
...
```bash
python .agents/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <your-stack>
...
```bash
python .agents/skills/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack nextjs
```
