...
>
> **강조 관문 (R-EMPH-01)**: 레이아웃을 고른 뒤 `../guide/디자인시스템.md`의 **R-EMPH-01 강조 선택표**를 반드시 통과시킨다. 민트 강조 3종(`.hl-mint-mark` 결론 / `.hl-mint-underline` 근거·조건 / `.hl-mint-text` 핵심어)이 **하나도 없으면 결론을 정하지 않은 것**이다. 의미는 집필 단계에서 이미 지정돼 온다(`skills/콘텐츠/SKILL.md` R-EMPH-02).
>
