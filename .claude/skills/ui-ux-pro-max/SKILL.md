...
> **Note:** On Windows, run the repository-local skill with `python .claude/skills/ui-ux-pro-max/scripts/search.py ...`.
...
```bash
python .claude/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <your-stack>
